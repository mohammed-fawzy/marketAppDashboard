...
var update = __webpack_require__(3)("1c3561cd", content, true, {});
...
// imports
exports.i(__webpack_require__(1046), "");
...
var map = {
	"./sets/brandico.json": 1049,
	"./sets/entypo.json": 1050
};
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Icons_vue__ = __webpack_require__(827);
/* empty harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_9f107036_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Icons_vue__ = __webpack_require__(1051);
function injectStyle (ssrContext) {
    ...
    computed: {
        sets() {
            ...
            !(function webpackMissingModule() { var e = new Error("Cannot find module \".\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()).forEach(name => {
                let set = __webpack_require__(1048)(this.setsPath + name + '.json');
